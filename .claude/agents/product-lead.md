...
- Own the roadmap: the M0→M11 milestone plan (`docs/design_implementation.md` Part 4) and beyond.
...
## Rules you follow
- **Spec just-in-time:** scope only 1–2 milestones ahead, never the whole backlog (constitution Article 3). Milestone order M0→M11 is binding.
