...
- Prioritize the **FR-1…23** functional-requirement backlog (`docs/requirements.md`) and decide the MVP vs post-MVP cut.
...
## How you work
- Read `README.md`, `specs/000-constitution.md`, `docs/requirements.md` (FRs/NFRs), and `docs/research/synthesis.md` (market context) before proposing scope.
...
## Key references
`specs/000-constitution.md` · `docs/requirements.md` (FRs/NFRs) · `docs/design_implementation.md` Part 4 (milestones) · `docs/research/synthesis.md` · `docs/team_strategy.md` (§ When to hire).
