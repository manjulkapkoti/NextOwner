...
- ~~Make root `test:api` cross-platform when CI arrives~~ **done in the CI PR** (`scripts/test-api.mjs`). Branch protection is plan-gated (private repo on the free plan) — revisit if the repo goes public / plan upgrades.
